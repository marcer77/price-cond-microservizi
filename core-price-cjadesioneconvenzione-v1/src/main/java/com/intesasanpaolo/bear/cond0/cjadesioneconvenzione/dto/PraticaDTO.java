...
public class PraticaDTO {
	...
	@Pattern(regexp = "[0-9]{13,13}", message = "Il campo codSuperPratica può essere solo numerico con lunghezza 13")
	...
	@Pattern(regexp = "[0-9]{13,13}", message = "Il campo codPratica può solo essere numerico con lunghezza 13")
