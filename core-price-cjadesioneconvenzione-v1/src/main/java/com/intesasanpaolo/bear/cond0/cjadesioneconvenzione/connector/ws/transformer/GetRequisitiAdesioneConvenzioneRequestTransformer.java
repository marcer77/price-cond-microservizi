...
@Service
public class GetRequisitiAdesioneConvenzioneRequestTransformer implements ISoapRequestTransformer<RequisitiAdesioneConvenzioneDTO,JAXBElement<AdesioneRequest>>{
	
	private ObjectFactory objectFactory = new ObjectFactory();

	@Override
	public SoapConnectorRequest<JAXBElement<AdesioneRequest>> transform(RequisitiAdesioneConvenzioneDTO input, Object... args) {
