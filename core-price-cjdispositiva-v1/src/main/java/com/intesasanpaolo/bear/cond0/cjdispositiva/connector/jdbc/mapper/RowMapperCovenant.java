	...
	public CovenantEntity mapRow(ResultSet rs, int rowNum) {
		...
		try {
			...
			covenant = CovenantEntity.builder().codCondizione(rs.getString("covCodCondizione"))
					...
					.beneficioIncondizionatoPresente(rs.getString("covBeneficioIncondizionatoPresente"))
					.beneficioIncondizionatoDatainizio(rs.getString("covBeneficioIncondizionatoDataInizio"))
					.beneficioIncondizionatoDatainizio(rs.getString("covBeneficioIncondizionatoDataFine"))
					.beneficioIncondizionatoNumRilevazioni(rs.getString("covBeneficioIncondizionatoNumRilevazioni"))
					.beneficioCondizionatoDataInizio(rs.getString("covBeneficioCondizionatoDataInizio"))
					.beneficioCondizionatoDataFine(rs.getString("covBeneficioCondizionatoDataFine"))
