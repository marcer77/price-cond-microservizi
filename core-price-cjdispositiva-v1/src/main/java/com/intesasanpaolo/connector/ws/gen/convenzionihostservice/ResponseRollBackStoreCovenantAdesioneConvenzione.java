...
/**
 * <p>Classe Java per Response_RollBackStoreCovenantAdesioneConvenzione complex type.
 * 
 * <p>Il seguente frammento di schema specifica il contenuto previsto contenuto in questa classe.
 * 
 * <pre>
 * &lt;complexType name="Response_RollBackStoreCovenantAdesioneConvenzione"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Response_RollBackStoreCovenantAdesioneConvenzione", propOrder = {
    "errorDescription",
    "hasError"
})
public class ResponseRollBackStoreCovenantAdesioneConvenzione {

    @XmlElementRef(name = "ErrorDescription", namespace = "http://schemas.datacontract.org/2004/07/IntesaSanPaolo.Pricing.WebServices.Common.DAL.Entities", type = JAXBElement.class, required = false)
