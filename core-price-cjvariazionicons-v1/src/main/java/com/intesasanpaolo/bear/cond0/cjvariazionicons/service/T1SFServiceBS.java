...
import com.intesasanpaolo.bear.cond0.cjvariazionicons.model.T1SFRequest;
import com.intesasanpaolo.bear.cond0.cjvariazionicons.model.T1SFResponse;
...
public class T1SFServiceBS extends BaseService {
	...
	public T1SFResponse callBS(T1SFRequest t1sfRequest) throws Exception {
		T1SFResponse t1sfResponse = this.ctgConnectorT1SF.call(t1sfRequest, requestTransformer, responseTransformer,null);
		return t1sfResponse;
	}
}
