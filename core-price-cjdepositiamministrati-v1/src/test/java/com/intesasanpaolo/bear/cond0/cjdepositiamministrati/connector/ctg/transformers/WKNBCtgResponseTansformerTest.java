...
import com.dsi.business.SSA_WK.integration.jdo.P_WKNBS00.OUTSTP;
...
public class WKNBCtgResponseTansformerTest extends BaseTest{
	...
	public void testTrasform() {
		CtgConnectorResponse<C_WKNBS00> ctgResponse=new CtgConnectorResponse<C_WKNBS00>();
		ctgResponse.setResult(new C_WKNBS00());
		...
		WKNBResponse wkibResponse = wkibCtgResponseTansformer.transform(ctgResponse);
